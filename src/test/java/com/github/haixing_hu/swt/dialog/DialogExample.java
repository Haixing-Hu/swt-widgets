...
public class DialogExample {
  public static void main(final String[] args) {
    ...
    button1.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button2.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button3.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button4.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button5.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button6.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button7.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button8.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button9.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button10.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button11.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button12.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button13.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
    ...
    button14.setLayoutData(new GridData(GridData.FILL, GridData.FILL, false,
        false));
  ...
  private static void displayConfirmExit() {
    final boolean confirm = Dialog.isConfirmed(
        "Are you sure you want to quit?", "Please do not quit yet!");
    System.out.println("Choice is..." + confirm);
  }

  private static void displayRadioChoice() {
    final int choice = Dialog.radioChoice("You've got selection to make",
  ...
  private static void displayDelayedQuit() {
    final boolean choice = Dialog.isConfirmed("Are you sure you want to quit?",
  ...
  private static void displaySecurityWarning() {
    ...
    System.out.println("The choice is " + dialog.getSelectedButton()
        + ", the checkbox value is " + dialog.getCheckboxValue());
  ...
  private static void displayProgressBar() {
    ...
    Display.getCurrent().timerExec(500, new Runnable() {
      ...
      public void run() {
        ...
        dialog.getMessageArea().setText(
            "Location : from 'Others' to 'Others'<br/>" +
  ...
  private static void displayInput() {
    final String input = Dialog.ask("Enter you name",
        "or any other text if you prefer", "Bill Gates");
  ...
  private static void displayComplex() {
    ...
    dialog
        ...
        .setIcon(SWTResourceManager.getImage(DialogExample.class, "images/warning.png"));
    dialog.show();
  ...
  private static void displayLargeText() {
    ...
    for (int t = 0; t < 20; t++) {
      builder.append("A <b>very</b> <size=10>long text (10)</size> ")
             .append(t)
             .append("<br/>")
             .append("A <b>very</b> <size=+12>long text (+12)</size> ")
             .append(t)
             .append("<br/>")
             .append("A <b>very</b> <size=-4>long text (-4)</size> ")
             .append(t)
             .append("<br/>")
             .append("A <b>very</b> <color=#088A29>long text</color> ")
             .append(t)
             .append("<br/>")
             .append("A <b>very</b> <color=255,0,255>long text</color> ")
             .append(t)
             .append("<br/>")
             .append("A <b>very</b> <color=navy>long text</color> ")
             .append(t)
             .append("<br/>")
             .append("A <b>very</b> <backgroundcolor=255,0,0>long text</backgroundcolor> ")
             .append(t )
             .append("<br/>")
             .append("A <b>very</b> <backgroundcolor=#FFFFCC>long text</backgroundcolor> ")
             .append(t)
             .append("<br/>")
             .append("A <b>very</b> <backgroundcolor=lavender>long text</backgroundcolor> ")
             .append(t)
             .append("<br/>")
             .append("A very long text ")
             .append(t)
             .append("<br/>")
             .append("...<br/>");
    }
    ...
    dialog.getMessageArea().setText(builder.toString());
    dialog.setButtonType(Dialog.Type.OK);
    dialog.show();
  }
  ...
  private static void testIssue29() {
    ...
    d.setCenterPolicy(Dialog.Option.CENTER_ON_DIALOG);
    d.setTitle("foo title");

    d.getMessageArea().setTitle("aaaa").setText("bbbb");

    d.getFooterArea().setButtonLabels(
        Arrays.asList("Don't Save please", "Cancel"));
    d.show();
