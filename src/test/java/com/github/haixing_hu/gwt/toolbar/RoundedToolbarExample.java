 ...
 *******************************************************************************/
package com.github.haixing_hu.gwt.toolbar;
...
public class RoundedToolbarExample {
	...
	public static void main(final String[] args) {
		...
		final ClassLoader cl = RoundedToolbarExample.class.getClassLoader();
		...
		emailb = SWTResourceManager.getImage(display,
		    RoundedToolbarExample.class, "/images/email_b.png");
		emailw = SWTResourceManager.getImage(display,
		    RoundedToolbarExample.class, "/images/email_w.png");
