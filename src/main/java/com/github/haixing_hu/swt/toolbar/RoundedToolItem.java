...
public class RoundedToolItem extends Item {
	...
	private static Color START_GRADIENT_COLOR = SWTResourceManager.getColor(70, 70, 70);
	private static Color END_GRADIENT_COLOR = SWTResourceManager.getColor(116, 116, 116);
