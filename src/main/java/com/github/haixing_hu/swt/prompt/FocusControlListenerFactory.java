...
class FocusControlListenerFactory {
  ...
  static BaseFocusControlListener getFocusControlListenerFor(
    ...
    throw new IllegalArgumentException("Control should be a Text, a Combo, "
        + "a CCombo or a StyledText widget");
  }
