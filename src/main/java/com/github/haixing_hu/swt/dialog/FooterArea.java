...
public class FooterArea extends DialogArea {
  ...
  public FooterArea(final Dialog parent) {
    ...
    this.expandedLabelText = messages.get(MESSAGE_FEWER_DETAILS);
    this.collapsedLabelText = messages.get(MESSAGE_MORE_DETAILS);
    this.timer = - 1;
  ...
  void render() {
    ...
    this.composite.setLayoutData(new GridData(GridData.FILL, GridData.FILL,
        true, false));
    this.composite.setBackground(this.getGreyColor());

    int numberOfColumns = this.buttonLabels == null ? 0 : this.buttonLabels
        .size();
    if (this.details) {
      numberOfColumns += 2;
    }
    ...
    if (this.details && (this.parent.getMessageArea().getException() == null)
        && this.expanded) {
  ...
  private void createButtons() {
    ...
    for (int i = 0; i < this.buttonLabels.size(); i++) {
      ...
      final GridData gd = new GridData(GridData.END, GridData.CENTER, i == 0,
          false);
  ...
  private void createDetails(final int numberOfColumns) {
    ...
    icon.setImage(this.isExpanded() ? this.getFewerDetailsImage() : this
        .getMoreDetailsImage());
    icon.setLayoutData(new GridData(GridData.CENTER, GridData.CENTER, false,
        false));

    final Label label = new Label(this.composite, SWT.NONE);
    label.setBackground(this.getGreyColor());
    label.setText(this.isExpanded() ? this.expandedLabelText
        : this.collapsedLabelText);
  ...
  private void createCheckBox(final int numberOfColumns) {
    ...
    button.setLayoutData(new GridData(GridData.BEGINNING, GridData.CENTER,
        true, false, numberOfColumns, 1));
    button.addSelectionListener(new SelectionAdapter() {
  ...
  private void createFooter() {
    ...
    final Composite informationComposite = new Composite(this.parent.shell,
        SWT.NONE);
    informationComposite.setLayoutData(new GridData(GridData.FILL,
        GridData.FILL, false, false));
    informationComposite.setBackground(this.getGreyColor());

    informationComposite.setLayout(new GridLayout(this.icon == null ? 1 : 2,
        false));
    ...
    if (this.icon != null) {
      ...
      labelIcon.setLayoutData(new GridData(GridData.CENTER, GridData.CENTER,
          false, false));
    }
    ...
    labelText.setLayoutData(new GridData(GridData.FILL, GridData.CENTER, true,
        false));
  }
  ...
  private void createExpandedPanel(final int numberOfColumns) {
    this.expandedPanel = new Text(this.composite, SWT.MULTI | SWT.READ_ONLY
        | SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL);
    this.expandedPanel.setText(this.detailText);
    this.expandedPanel.setBackground(this.getGreyColor());
    final GridData gd = new GridData(GridData.FILL, GridData.FILL, false,
        false, numberOfColumns, 1);
  ...
  private void createSeparator() {
    ...
    separator.setLayoutData(new GridData(GridData.FILL, GridData.FILL, true,
        false));
