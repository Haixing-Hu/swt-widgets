 ...
 * @author Haixing Hu
 */
public class ActionContributionItemEx extends ContributionItem {
   ...
   * contribution items are equal if they refer to the identical ActionEx.
   */
  @Override
  public boolean equals(Object o) {
    if (! (o instanceof ActionContributionItemEx)) {
      return false;
    }
    return action.equals(((ActionContributionItemEx) o).action);
  }
