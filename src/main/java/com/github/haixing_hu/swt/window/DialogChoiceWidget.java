...
public class DialogChoiceWidget extends Composite {
  ...
  private void buildGreenArrow() {
    final Image greenArrow = SWTResourceManager.getImage(this.getClass(), ARROW_IMAGE);
    this.image = new Label(this, SWT.NONE);
    this.image.setImage(greenArrow);
    this.image.setLayoutData(new GridData(GridData.CENTER, GridData.BEGINNING,
        false, false, 1, 2));
  }
  ...
  private void buildInstruction() {
    ...
    this.instruction.setLayoutData(new GridData(GridData.BEGINNING,
  ...
  private void buildText() {
    ...
    this.text.setLayoutData(new GridData(GridData.BEGINNING,
  ...
  private void drawComposite() {
    ...
    if (! inside && ! this.selection) {
      ...
      final Color gradientColor = inside ? new Color(getDisplay(), 220, 231,
          243) : new Color(getDisplay(), 241, 241, 241);
      ...
      gc.drawRoundRectangle(rect.x, rect.y, rect.width - 1, rect.height - 1, 2,
          2);
