 ...
 *     Haixing Hu - Modify for personal use.
 *******************************************************************************/
 ...
 * <ul>
 *   <li>creating an instance of {@link ApplicationWindowEx}
 *   </li>
 ...
 * except that it use our modified {@link MenuManagerEx}.
 * </p>
 *
 * @author Haixing Hu
 */
public class ApplicationWindowEx extends Window implements IRunnableContext {
     ...
     * @see #addMenuBar
     */
    private MenuManagerEx menuBarManager = null;
    ...
    /**
     * The separator between the menu bar and the rest of the window.
     */
   ...
   * @param style swt style bits used to create the Coolbar
     ...
     * @see #addMenuBar()
     */
    public MenuManagerEx getMenuBarManager() {
